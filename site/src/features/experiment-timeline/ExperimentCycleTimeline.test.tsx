...
it('renders the source-qualified Yb cycle with five selectable stages and separated time scales', async () => {
  ...
  expect(screen.getByRole('img', { name: /Optical timing diagram for a 171Yb replacement-aware experimental cycle/ })).toHaveAttribute('src', expect.stringContaining('yb-replacement-cycle-timeline.svg'))
