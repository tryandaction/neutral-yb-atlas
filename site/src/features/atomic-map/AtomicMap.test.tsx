...
it('uses normalized image coordinates to move the teaching ring and arrow precisely', async () => {
  ...
  expect(screen.getByTestId('reference-mobile-lens')).toHaveAttribute('data-focus-x', '28')
  expect(screen.getByTestId('reference-mobile-lens')).toHaveAttribute('data-focus-y', '56.5')
