...
export const computationRows: ComputationRow[] = [
  {
    ...
    definition: String.raw`\rho_0=V\rho_LV^\dagger`,
  ...
  },
  {
    ...
    definition: String.raw`i\hbar\,\partial_t|\psi(t)\rangle=H[u(t)]|\psi(t)\rangle`,
  ...
  },
  {
    ...
    definition: String.raw`p(m)=\operatorname{Tr}(E_m\rho)`,
  ...
  },
  {
    ...
    definition: String.raw`\mathcal N_L=\mathcal R\circ\mathcal M\circ\mathcal N_{\mathrm{phys}}`,
